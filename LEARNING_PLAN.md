...
本学习方案共分为 **7个阶段，25个主题**，从基础到高级循序渐进。每完成一个主题，请在对应的checkbox中打钩 ✅

**预计学习时间**：35-45小时（根据个人基础调整）

**重要说明**：
- 本课程基于 **LangChain v1** 和 **LangGraph v1**
- 专注于 LangChain 核心功能，LangGraph 作为高级补充
- 官方建议：先掌握 LangChain，需要精细控制时再学 LangGraph
...
- 适合复杂的多步骤推理场景
- Agent可以多次调用检索工具
- Hybrid RAG结合了2-Step和Agentic的优点
- 可以结合多种检索策略
...
## 💾 第五阶段：持久化与状态管理（Persistence & State）

> **目标**：理解LangGraph的持久化机制，实现有状态的对话
